      ...
      <div className="flex">
        ...
        <div className="w-64 bg-gradient-to-b from-primary-900 via-primary-800 to-primary-900 dark:from-boxdark dark:to-boxdark h-screen shadow-2xl flex flex-col z-50">
          <div className="flex flex-col h-full">
            {/* OTEC Logo */}
            <div className="px-4 pt-6 pb-4 flex-shrink-0 border-b border-primary-700/50 dark:border-strokedark">
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1 min-h-0">
              <Link
                to="/dashboard"
                className="flex items-center space-x-3 px-4 py-3 text-blue-100 dark:text-bodydark2 hover:bg-primary-700 dark:hover:bg-meta-4 hover:shadow-md transition-all duration-200 rounded-lg"
              >
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3 text-blue-100 dark:text-bodydark2 hover:bg-primary-700 dark:hover:bg-meta-4 hover:shadow-md transition-all duration-200 rounded-lg"
                >
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                ...
                {showOperationsMenu && (
                  <div className="mt-1 ml-4 space-y-1 max-h-48 overflow-y-auto">
                    <Link
                      to="/operations/tools"
                      className="flex items-center space-x-3 px-4 py-2 text-sm text-blue-50 dark:text-bodydark2 hover:bg-primary-700 dark:hover:bg-meta-4 hover:shadow-md transition-all duration-200 rounded-lg"
                    >
              ...
              <Link
                to="/orders"
                className="flex items-center space-x-3 px-4 py-3 bg-primary-700 dark:bg-primary text-white rounded-lg"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="flex items-center space-x-3 px-4 py-3 text-blue-100 dark:text-bodydark2 hover:bg-primary-700 dark:hover:bg-meta-4 hover:shadow-md transition-all duration-200 rounded-lg">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <span>Customers</span>
        ...
        <div className="flex-1">
          ...
          {/* Order Header */}
          <div className="bg-white dark:bg-boxdark border-b border-gray-200 dark:border-strokedark px-6 py-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <button className="px-3 py-1.5 bg-primary-100 dark:bg-meta-4 text-primary-800 dark:text-white rounded-lg text-sm font-medium flex items-center space-x-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button className="px-4 py-2 border border-gray-300 dark:border-strokedark rounded-lg text-sm font-medium text-gray-700 dark:text-white bg-white dark:bg-boxdark hover:bg-gray-50 dark:hover:bg-meta-4 flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button className="px-4 py-2 border border-gray-300 dark:border-strokedark rounded-lg text-sm font-medium text-red-700 dark:text-red-500 bg-white dark:bg-boxdark hover:bg-red-50 dark:hover:bg-meta-4 flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                  <button
                    ...
                    className="px-4 py-2 border border-gray-300 dark:border-strokedark rounded-lg text-sm font-medium text-gray-700 dark:text-white bg-white dark:bg-boxdark hover:bg-gray-50 dark:hover:bg-meta-4 flex items-center space-x-2"
                  >
                    <span>MORE</span>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  ...
                  {showMoreMenu && (
                    <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-boxdark rounded-lg shadow-lg border border-gray-200 dark:border-strokedark z-20">
                      <button className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-bodydark1 hover:bg-gray-50 dark:hover:bg-meta-4 rounded-t-md">Export Order</button>
                      <button className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-bodydark1 hover:bg-gray-50 dark:hover:bg-meta-4">Duplicate Order</button>
                      <button className="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-bodydark1 hover:bg-gray-50 dark:hover:bg-meta-4 rounded-b-md">Archive Order</button>
                    </div>
                  )}
                </div>
          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-boxdark rounded-lg shadow p-6">
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Customer & Order Creation</h3>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <span className="text-sm font-medium text-gray-700 dark:text-bodydark1">Customer:</span>
                        <Link
                          to={`/customers/${order.customer.id}`}
                          className="text-primary-600 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300 text-sm flex items-center space-x-1"
                        >
                ...
                <div className="bg-white dark:bg-boxdark rounded-lg shadow">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Shipping & Billing Details</h3>
                    </div>
                  ...
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 dark:border-strokedark rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 bg-transparent dark:text-white"
                      />
                ...
                <div className="bg-white dark:bg-boxdark rounded-lg shadow">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Recommended Items</h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-boxdark rounded-lg shadow p-6">
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                      ...
                      <textarea
                        className="w-full px-4 py-2 border border-gray-300 dark:border-strokedark rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 mb-2 bg-transparent dark:text-white"
                        rows={3}
            ...
            {activeTab === 'related' && (
              <div className="bg-white dark:bg-boxdark rounded-lg shadow p-6">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Related Orders</h2>
                <p className="text-gray-600 dark:text-bodydark2">No related orders found</p>
              </div>
            )}
