    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-auto" style={{ fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div className="p-4 md:p-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-[70vh] gap-4">
            <div className="opacity-20"><svg className="w-16 h-16 mx-auto text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg></div>
