...
const Dashboard = () => {
  ...
  const DHT_CATS = ['Reamers', 'Anti Stick Slip', 'Scrapper', 'Jars', 'Handling Tools DHT'];
  const CATEGORY_DISPLAY: Record<string, string> = {
    ...
    'Scrapper': 'SCRAPPER', 'Jars': 'JARS', 'Handling Tools DHT': 'HANDLING TOOLS'
  };
        ...
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 w-full">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 xl:ml-auto">
            <div className="flex items-center gap-4">
              ...
              {/* Stock */}
              <Link to="/operations/inventory" className="glass-premium dark:bg-boxdark/80 px-5 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-4 group relative overflow-hidden cursor-pointer">
            ...
            <Link
              to="/orders"
              className="px-6 py-3 ml-2 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-xl text-sm font-bold shadow-[0_0_15px_rgba(25,86,168,0.3)] hover:shadow-[0_0_25px_rgba(25,86,168,0.5)] transition-all duration-300 transform hover:-translate-y-0.5 flex items-center space-x-2 border border-white/10"
            >
